...
const filterStringsWithVowels = (arr) => {
  // Solution code here...
  let rule = /[aeiou]/ ;
  arr = arr.filter(ele=> ele.match(rule));
  return arr;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  arr = arr.filter(ele => !(forbiddenValues.includes(ele)));
  return arr;
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  arr = arr.filter(ele => (ele.baseStat > minBaseStat));
  return arr;
};
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  arr = arr.filter(ele => (ele.baseStat > minBaseStat));
  arr = arr.map(ele => ele = ele.stat.name);
  return arr;
};
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  arr = arr.filter(ele=> !(ele.children));
  return arr;
};
