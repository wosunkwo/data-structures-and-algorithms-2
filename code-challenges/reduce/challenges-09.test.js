...
const returnNames = (arr) => {
  // Solution code here...
  arr = arr.reduce( (sum,current) => sum.concat(current.name), []);
  return arr;
};
...
const reversedString = (arr) => {
  // Solution code here...
  arr = arr.split('').reduce( (sum,cur) => cur.concat(sum));
  return arr;
};
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  arr = arr.reduce( ( sum, curr) => sum + (curr.children ? curr.children.length : 0), 0);
  return arr;
};
...
const calculateAverage = (arr) => {
  // Solution code here...
  arr = arr.reduce( (sum, curr) => sum+curr) / arr.length;
  return arr;
};
...
const countPrimeNumbers = (arr) => {
  // Solution code here...
  let count = 0 ;
  arr = arr.reduce( (sum,curr) => (isPrime(curr)? count++ : count),0);
  return arr ;
};
